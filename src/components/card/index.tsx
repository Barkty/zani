...
export const CardFlex = ({ flex, icon, title }: CardProps) => {
    return (
        <div data-testid='card-flex' className={`p-4 md:p-2 items-center justify-around bg-white hover:drop-shadow-xl mb-3.5 duration-200 ease-in cursor-pointer ${flex === 'column' ? 'flex-col h-[248px] w-2/6 md:w-full' : 'flex h-[139px]'}`}>
